...
class Config(BaseSettings):
    ...
    composio_auth_config_snowflake: str = os.environ.get("COMPOSIO_AUTH_CONFIG_SNOWFLAKE", "")
    composio_auth_config_databricks: str = os.environ.get("COMPOSIO_AUTH_CONFIG_DATABRICKS", "")
